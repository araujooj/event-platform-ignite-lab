...
export type Subcriber_CreationMutationVariables = Exact<{
  name: Scalars['String'];
  email: Scalars['String'];
}>;


export type Subcriber_CreationMutation = { __typename?: 'Mutation', createSubscriber?: { __typename?: 'Subscriber', id: string } | null };
...
export const Subcriber_CreationDocument = gql`
  ...
  createSubscriber(data: {name: $name, email: $email}) {
    ...
    `;
export type Subcriber_CreationMutationFn = Apollo.MutationFunction<Subcriber_CreationMutation, Subcriber_CreationMutationVariables>;

/**
 * __useSubcriber_CreationMutation__
 *
 * To run a mutation, you first call `useSubcriber_CreationMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSubcriber_CreationMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [subcriberCreationMutation, { data, loading, error }] = useSubcriber_CreationMutation({
 *   variables: {
 *      name: // value for 'name'
 ...
 * });
 */
export function useSubcriber_CreationMutation(baseOptions?: Apollo.MutationHookOptions<Subcriber_CreationMutation, Subcriber_CreationMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<Subcriber_CreationMutation, Subcriber_CreationMutationVariables>(Subcriber_CreationDocument, options);
      }
export type Subcriber_CreationMutationHookResult = ReturnType<typeof useSubcriber_CreationMutation>;
export type Subcriber_CreationMutationResult = Apollo.MutationResult<Subcriber_CreationMutation>;
export type Subcriber_CreationMutationOptions = Apollo.BaseMutationOptions<Subcriber_CreationMutation, Subcriber_CreationMutationVariables>;
